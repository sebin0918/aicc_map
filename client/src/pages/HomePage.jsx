...
const images = [
  { src: require('../images/testtest11.png'), className: 'image-1' },
  { src: require('../images/test_2.png'), className: 'image-2' },
  { src: require('../images/test_3.png'), className: 'image-3' },
  { src: require('../images/test_4.png'), className: 'image-4' },
  { src: require('../images/test_5.png'), className: 'image-5' },
];
